...
kind: page-spec
status: draft
status_note: "Tab structure shipped (Overview/History real, others stubs); history tab polish + multi-host group panel landed in phase 10c; compose/policies/promote actions deferred"
created: 2026-05-03
updated: 2026-05-06
tags:
  - design
...
- Shipped (Phase 10c): `<DeploymentGroupPanel />` for multi-host rolling deploys (progress bar + per-host strip + abort), History tab polish (state/strategy/service/range filter chips, row expand with event timeline, group indicator chip on grouped rows)
